...
const RemoveImageDialog = ({
  ...
  return (
    <AlertDialog
      swipePercent={0.2}
      className="h-[calc(47*var(--vh))] min-h-[300px]"
      isVisible={isVisible}
    ...
    >
      ...
      <AlertDialog.Body className="flex flex-row gap-4 flex-start py-6 px-4">
        ...
        <div>
          <Image
            width={72}
            height={72}
            src={"https://qmwtuvttspuxwuwrsuci.supabase.co/storage/v1/object/public/pokitokiStorage/phone_info_1.webp"}
